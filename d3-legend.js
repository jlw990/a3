...
})(
  {
      ...
      function (require, module, exports) {
        ...
        function color() {
          var scale = (0, _d3Scale.scaleLinear)(),
            ...
            path = void 0,
            titleWidth = void 0,
            legendDispatcher = (0, _d3Dispatch.dispatch)(
              "cellover",
              "cellout",
              "cellclick"
            );
          ...
          function legend(svg) {
            ...
            var cellTrans = void 0,
              textTrans = void 0,
              textAlign =
                labelAlign == "start" ? 0 : labelAlign == "middle" ? 0.5 : 1;
    ...
    12: [
      function (require, module, exports) {
        ...
        var thresholdLabels = (exports.thresholdLabels = function thresholdLabels(
          _ref
        ) {
          var i = _ref.i,
    ...
    13: [
      function (require, module, exports) {
        ...
        var d3_mergeLabels = function d3_mergeLabels() {
          ...
          if (
            (typeof labels === "undefined" ? "undefined" : _typeof(labels)) ===
            "object"
          ) {
        ...
        var d3_linearLegend = function d3_linearLegend(
          scale,
          cells,
          labelFormat
        ) {
        ...
        var d3_quantLegend = function d3_quantLegend(
          scale,
          labelFormat,
          labelDelimiter
        ) {
        ...
        exports.default = {
          ...
          d3_addText: function d3_addText(
            svg,
            enter,
            labels,
            classPrefix,
            ...
            var text = svg
              .selectAll(
                "g." + classPrefix + "cell text." + classPrefix + "label"
              )
              .data(labels)
              .text(d3_identity);
            ...
            if (orient === "vertical") {
              (function () {
                ...
                var y =
                  shape == "circle" || shape == "line"
                    ? shapeSize[0].height / 2
                    : 0;
                cellTrans = function cellTrans(d, i) {
                  var height = (0, _d3Array.sum)(cellSize.slice(0, i));

                  return (
                    "translate(0, " + (y + height + i * shapePadding) + ")"
                  );
                };
              ...
              (function () {
                cellTrans = function cellTrans(d, i) {
                  ...
                  return (
                    "translate(" + (width + i * shapePadding) + ", " + y + ")"
                  );
                };
